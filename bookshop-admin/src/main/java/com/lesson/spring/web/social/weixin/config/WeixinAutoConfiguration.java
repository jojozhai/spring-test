...
public class WeixinAutoConfiguration {
	...
	protected static class WeixinConfigurerAdapter extends SocialAutoConfigurerAdapter {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.springframework.boot.autoconfigure.social.
		 * SocialAutoConfigurerAdapter#createConnectionFactory()
		 */
		@Override
		protected ConnectionFactory<?> createConnectionFactory() {
			return new WeixinConnectionFactory("weixin", this.properties.getAppId(), this.properties.getAppSecret());
		}
		...
		public GenericConnectionStatusView weixinConnectView() {
			return new GenericConnectionStatusView("weixin", "Weixin");
		}
